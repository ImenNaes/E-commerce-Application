    ...
    jQuery(document).ready(function ($) {
        ...
        if ($('#phone').length) {
            jQuery("#phone").intlTelInput({
                ...
                utilsScript: "/Innerstore/plugins/intltelinput/js/utils.js" // just for formatting/placeholders etc
            });
        ...
        }, ".nav-category ul li.dropdown"); //pass the element as an argument to .on
        $('.nav-category ul li.dropdown').on('touchstart', function (e) {
            // e.preventDefault();
            $(this).find('.dropdown-menu').stop(true, true).delay(200).fadeIn(500);
        });
        $('.nav-category ul li.dropdown').on('touchend', function (e) {
            //e.preventDefault();
            $(this).find('.dropdown-menu').stop(true, true).delay(2000).fadeOut(500);
        });
        $('.withlink').on('click vclick tap', function () {
